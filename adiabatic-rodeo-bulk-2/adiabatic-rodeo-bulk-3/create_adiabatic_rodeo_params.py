...
adiabatic_times = np.linspace(0,60,20)
#r_values = [int(j) for j in np.linspace(1,1,1)]
r_values = [0]
sigma_values = [3.3] #[17.984] #[164] # using 3.3 for the [2,2] case using 5.76 for the [4,4] case. 10.8 for the [8,8] case, 21 for [16,16] case, 82 for [64,64], 164 for [128,128]
i = 0
for adiabatic_time in adiabatic_times:
    for r_value in r_values:
        for sigma_value in sigma_values:
            data = {
            'initial_guess_lat': [['down'],['down'],['down'],['up']], #2*[["down"]] + 2*[['up']], #[['down'],['up']], #[['down'],['down'],['down'],['up']],#[['down'],['up']],
            'dmrg_params' : {
